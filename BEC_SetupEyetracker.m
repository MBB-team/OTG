function [eye_calibration] = BEC_SetupEyetracker(window,exp_settings)
...
%% Instruction
    exitflag = S10_Exp_InstructionScreens(window,exp_settings,'eyetracker');
    if exitflag; S10_Exp_ExitExperiment(AllData); return; end %Terminate experiment
