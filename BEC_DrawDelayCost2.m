function [t_onset] = BEC_DrawDelayCost2(window,exp_settings,drawchoice)
% ---- Note: this is an old version of the delay cost visualization function; it has now been replaced but will be kept
% ---- in BECHAMEL for historic purposes (e.g. in case it's needed for reproducing results from before February 2021).
